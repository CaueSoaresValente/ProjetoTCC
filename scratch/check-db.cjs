...
const { AppDataSource } = require('../dist/backend/config/data-source.js');
const { Area } = require('../dist/backend/modules/area/area.entity.js');
const { Professor } = require('../dist/backend/modules/professor/professor.entity.js');
