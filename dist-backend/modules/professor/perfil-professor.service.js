...
export class PerfilProfessorService {
    ...
    async buscarPerfilCompleto(idProfessor) {
    ...
    agruparTurmasPorId(professorTurmas) {
        const turmasMap = new Map();
        for (const pt of professorTurmas) {
            if (!pt.turma || !pt.turma.status)
                continue;
...
//# sourceMappingURL=perfil-professor.service.js.map